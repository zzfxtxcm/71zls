 ...
 */
class IsLinkController extends AdminController {
    ...
    public function index(){
        $tree = D('Islink')->getTree(0,'id,name,title,sort,pid,allow_publish,status');
    ...
    public function remove(){
        ...
        $child = M('Islink')->where(array('pid'=>$cate_id))->field('id')->select();
        if(!empty($child)){
